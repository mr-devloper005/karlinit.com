...
const inputClass = 'h-12 rounded-xl border border-black/15 bg-white px-4 text-base font-bold text-[#14231d] outline-none transition placeholder:text-[#718078] focus:border-[#16784a] focus:ring-4 focus:ring-[#16784a]/10'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-xl bg-[#16784a] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#12653e] disabled:opacity-60'
