    ...
    <EditableSiteShell>
      <main className="bg-[#f7f8f4] text-[#14231d]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-[var(--editable-container)] items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
          <div className="rounded-3xl bg-[#dff2e7] p-7 sm:p-10">
          ...
          <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-[0_24px_70px_rgba(16,36,31,0.10)] sm:p-8">
