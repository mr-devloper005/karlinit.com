...
export const editableRootStyle = {
  '--slot4-page-bg': '#f7f8f4',
  '--slot4-page-text': '#14231d',
  '--slot4-panel-bg': '#e8f2eb',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#53635b',
  '--slot4-soft-muted-text': '#718078',
  '--slot4-accent': '#16784a',
  '--slot4-accent-fill': '#16784a',
  '--slot4-accent-soft': '#dff2e7',
  '--slot4-dark-bg': '#10251c',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#edf1ed',
  '--slot4-cream': '#f2f6f1',
  '--slot4-warm': '#fbfcfa',
  '--slot4-lavender': '#e4f0e8',
  '--slot4-gray': '#f3f5f3',
  '--slot4-body-gradient': 'linear-gradient(180deg, #f7f8f4 0%, #ffffff 45%, #f3f6f3 100%)',
  '--editable-container': '1180px',
  '--editable-page-bg': '#f7f8f4',
  '--editable-page-text': '#14231d',
  '--editable-border': 'rgba(20,35,29,0.12)',
} as CSSProperties
